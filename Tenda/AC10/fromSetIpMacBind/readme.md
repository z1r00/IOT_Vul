...
/goform/fromSetIpMacBind, The static_list is controllable, it will assign the value to the list, and finally use strcpy to copy the list to mib_buf. It is worth noting that there is no size check, which leads to a stack overflow vulnerability
...
p3 = b"POST /goform/fromSetIpMacBind" + b" HTTP/1.1" + rn
